...
This project is maintained by Sai Nikhil Mattapalli, an AI/ML Engineer focused on building and deploying scalable machine learning and generative AI solutions.

### About the Developer
Sai Nikhil has over 5 years of experience in the healthcare and IT domains, specializing in Python, TypeScript, and React. He focuses on creating robust end-to-end ML pipelines and modern web applications, with expertise in LLMs, RAG, and cloud infrastructure.
